  ...
  const handleSubmit = async (e) => {
    ...
    if (action === 'Sign Up') {
      ...
      try {
        ...
        if (response.ok) {
          // After signup, go to login with email pre-filled
          setAction('Login');
          setPassword('');
          setConfirmPassword('');
          setName('');
      ...
      >
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          <AnimatePresence mode="popLayout">
            ...
            {/* Role dropdown — shown on both Sign Up and Login */}
            <motion.div
              key="userType"
              layout
            ...
            >
              <label>{action === 'Sign Up' ? 'Register As:' : 'Login As:'}</label>
              <select
                value={userType}
            ...
            {/* Email */}
            <motion.div key="email" layout className="input-group">
            ...
            {/* Password */}
            <motion.div key="password" layout className="input-group">
